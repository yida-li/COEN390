...
public class GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteGraph.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               delete();
                Toast.makeText(getApplicationContext(), "Graph Deleted: Please Refresh Page", Toast.LENGTH_LONG).show();
            }
        });
  ...
  //  airQSeries.appendData(new DataPoint(airQLastVal++, i), false, 20);
